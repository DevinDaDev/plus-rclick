      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10 sm:px-6 md:flex-row md:items-start md:justify-between">
        <div className="max-w-sm">
          <p className="text-base font-semibold text-primary-foreground">
            Right Click <span className="text-sky-400">Plus</span>
          </p>
        ...
        <nav className="flex flex-col gap-2 text-sm">
          <p className="font-medium text-slate-200">Explore</p>
          <Link href="/network" className="text-slate-400 hover:text-white">
            Network Equipment
          </Link>
          <Link href="/computers" className="text-slate-400 hover:text-white">
            Business Computers
          </Link>
